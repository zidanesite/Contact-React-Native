        ...
        <View style={styles.container}>
          ...
          >
            ...
            <View style={{marginLeft: 15}}>
              <Text style={styles.name}>Adwoa Asantewaa</Text>
              <Text style={styles.status}>Secretary, Shepherdd</Text>
            </View>
          </View>
          <View
            style={[
          ...
          <View style={styles.detailIcons}>
              <FontAwesome
                ...
                color="#4d73b8"
              />
              <Text style={styles.text}>+91 000 000 000</Text>
            </View>
            <View style={styles.detailIcons}>
              <Entypo
                name="message"
                ...
                color="#4d73b8"
              />
              <Text style={styles.text}>adwoa@shepherdd.inc</Text>
            </View>
            <View style={styles.detailIcons}>
              <FontAwesome
                name="map-marker"
                ...
                color="#4d73b8"
              />
              <Text style={styles.text}>Detroit, Michigan</Text>
            </View>
          </View>
        </View>
      );
